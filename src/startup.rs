...
use actix_web::{dev::Server, middleware, web::{self, Data}, App, HttpServer};
use libzeropool::fawkes_crypto::backend::bellman_groth16::{verifier, engines::Bn256};
...
pub fn run(listener: TcpListener, sender: Sender<Arc<Transaction>> , vk : verifier::VK<Bn256>) -> Result<Server, std::io::Error> {
